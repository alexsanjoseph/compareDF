...
_For the purpose of the readme I am attaching the html as a png because github markdown doesn't retain styles_

```{r, results = 'hide'}
print(ctable_student$html_output)
```
<img src="github_assets/pic_1.png" alt="Bring on the, github! " width="600" />
