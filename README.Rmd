...
Now let's compare the performance of the students across the years. The grouping variables are
the `Division` and the `Student` columns.

```{r}
library(compareDF)
ctable = compare_df(results_2011, results_2010, c("Student", "Division"))
